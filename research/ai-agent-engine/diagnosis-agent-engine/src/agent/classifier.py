...
class PlantDiseaseClassifier:
    ...
    def predict(self, image_url, top_k=3):
        """
        Predict plant disease from an image URL
        ...
        Returns:
            Dictionary with:
            - predictions: List of dicts with keys 'label' and 'confidence'
            - metadata: Additional info about the analysis
        """
        try:
            # Download image
