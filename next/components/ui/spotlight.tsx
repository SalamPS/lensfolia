...
export const Spotlight = ({
  ...
  return (
    ...
    >
      {/* Left Spotlight - hidden on mobile */}
      <motion.div
        animate={{ x: [0, xOffset, 0] }}
        transition={{ duration, repeat: Infinity, repeatType: "reverse", ease: "easeInOut" }}
        className="pointer-events-none absolute top-0 left-0 z-10 h-screen w-screen lg:block hidden"
      >
        {/* Gradient 1 (Teal) */}
        <div
          style={{
