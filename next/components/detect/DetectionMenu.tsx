	...
	return (
		<LFDWrapper onDrop={handleDrop} onDragOver={handleDragOver}>
			...
			{!captureUrl ? 
				...
				: 
				<section className="p-6 border-[1px] border-border border-dashed bg-card/[0.5] backdrop-blur-xs"
					id='preview-image'>
			...
			<div className="fixed top-0 items-center justify-center z-50"
...
function LFDISContainer({children, title, subtitle, onClick}: LFDISContainerProps) {
	return <div className={`p-5 border-[1px] border-border border-dashed bg-card/[0.5]`}>
